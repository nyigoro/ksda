...
var api_default = {
  async fetch(req, env) {
    ...
    if (url.pathname === "/api/songs") {
      console.log("Handling GET /api/songs - Returning hardcoded data");
      return Response.json([
        {
          id: "test-1",
          title: "Hardcoded Song 1",
          artist: "Test Artist",
          youtube_link: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
          lyrics: "These are hardcoded lyrics for song 1."
        },
        {
          id: "test-2",
          title: "Hardcoded Song 2",
          artist: "Another Artist",
          youtube_link: "https://www.youtube.com/watch?v=o-YBDTqX_ZU",
          lyrics: "These are hardcoded lyrics for song 2."
        }
      ]);
    }
...
// .wrangler/tmp/bundle-m6f694/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-m6f694/middleware-loader.entry.ts
